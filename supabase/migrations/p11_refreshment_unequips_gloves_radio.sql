-- =============================================================
-- p11: hand item (coffee / snack / thermos / energy) unequips
--      gloves and radio so they do not fight the hand pose.
...
BEGIN
  ...
  IF v_kind = 'refreshment' THEN
    ...
    -- Hand pose cannot share a layer with gloves / radio cutouts
    UPDATE public.user_inventory
       SET equipped = false
     WHERE user_id = v_user_id
